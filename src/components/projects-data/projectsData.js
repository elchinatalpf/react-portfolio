...
const projects = [
  ...
  },
  {
    ...
    projectLink:
      'https://elchinatalpf.github.io/Server-Side-APIs-Weather-Dashboard/',
    repoLink:
      'https://github.com/elchinatalpf/Server-Side-APIs-Weather-Dashboard',
  },
  {
    ...
    projectLink:
      'https://elchinatalpf.github.io/password-generator-starter-code/',
  ...
  },
  {
    ...
    imageAtl: 'Screenshot of the Password Generator Project',
    projectLink:
      'https://drive.google.com/file/d/1enUxjU8B5Euk1A4pvSUaBHcwxTwo7Mj-/view?pli=1',
